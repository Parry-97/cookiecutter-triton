...
@triton.jit
def {{ cookiecutter.kernel_name }}_kernel(
    # Pointers to tensors
    x_ptr,
    output_ptr,
    # Size of the input
    ...
    """
    Triton kernel for {{ cookiecutter.kernel_description | lower }}.
...
def {{ cookiecutter.kernel_name }}(x: torch.Tensor) -> torch.Tensor:
    """
    ...
    # Launch the kernel
    {{ cookiecutter.kernel_name }}_kernel[grid](
        x,
        output,
        n_elements,
